...
# Objetivos
- Aplicar conceitos teóricos de robótica em um projeto prático
- Desenvolver habilidades de programação e controle de hardware
- Compreender a integração entre sensores, atuadores e controladores
- Estimular trabalho em equipe e organização de projetos tecnológicos

# Tecnologias e Conceitos Utilizados
- Programação para sistemas embarcados
- Eletrônica básica aplicada à robótica
- Sensores e atuadores
- Lógica de controle e automação
- Metodologia prática de desenvolvimento de projetos
